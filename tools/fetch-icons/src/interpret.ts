...
const fetchAiTagsBatch = async (names: string[]): Promise<Record<string, string[]>> => {
...
const main = async () => {
  ...
  if (!existsSync(PACKS_DIR)) { await fs.mkdir(PACKS_DIR, { recursive: true }); }
